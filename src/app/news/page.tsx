   ...
   const cardData = [
      {
         ...
         created: "MAY 18, 2023",
         content:
            "Micro-fulfillment centers are small, automated warehouses located in urban areas. They enable retailers and e-commerce companies to store products closer to consumers, reducing delivery distances and time. These centers use robotics and automation to quickly process orders.",
         type: "News",
      },
      {
         image: "futuristic-truck.jpg",
                        ...
                        <MUICard>
                           ...
                           <MUICardContent>
                              ...
                              <MUIBox className="card-sub-title">
                                 <MUITypography className="type">{item.type}</MUITypography>
                              ...
                              <MUITypography className="card-content">{displayContent(item.content)}</MUITypography>
                           </MUICardContent>
                           <MUICardActions>
                              <MUILink></MUILink>
                              <MUIBox
