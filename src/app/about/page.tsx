...
const aboutContent = [
   {
      title: "Tầm nhìn",
      content:
         "Hải Sâm hướng tới trở thành đơn vị dẫn đầu trong lĩnh vực dịch vụ logistics tại Việt Nam và khu vực, không ngừng đổi mới và phát triển để đáp ứng nhu cầu ngày càng cao của thị trường.",
   },
   {
      title: "Sứ mệnh",
      content:
         "Hải Sâm luôn đặt lợi ích của khách hàng lên hàng đầu, đảm bảo sự hài lòng và tin cậy thông qua các dịch vụ chất lượng, mang đến các giải pháp logistics chất lượng cao, hiệu quả và đáng tin cậy cho khách hàng. Chúng tôi mong muốn góp phần vào sự phát triển bền vững của doanh nghiệp, cộng đồng và nền kinh tế.",
   },
];
      ...
      <>
         ...
         <ContentStyled>
            <MUIBox className="container mx-auto">
               <MUIGrid container>
                  <MUIGrid item md={7} xs={12}>
                     ...
                     >
                        ...
                        <Divider sx={{ mb: "20px" }} />
                        <MUIBox data-aos="fade-up" data-aos-delay="300" data-aos-duration="2000">
                           <MUITypography
                              sx={{
                                 fontWeight: "500",
               ...
               >
                  Hải Sâm có trụ sở tại Quảng Ninh, là một đơn vị hàng đầu trong lĩnh vực dịch vụ logistics. Với đội ngũ
                  nhân viên giàu kinh nghiệm và kiến thức chuyên sâu về logistics cũng như đội vận tải lớn mạnh, Hải Sâm
                  cung cấp một loạt các dịch vụ đa dạng từ cho thuê kho đến cung cấp dịch vụ vận tải hay xuất nhập khẩu
                  hàng hoá…, đáp ứng mọi nhu cầu của khách hàng. Cơ sở vật chất hiện đại và việc ứng dụng công nghệ tiên
                  tiến giúp Hải Sâm đảm bảo chất lượng dịch vụ cao, tối ưu hóa hoạt động logistics và tiết kiệm chi phí
                  cho khách hàng. Hải Sâm cam kết mang đến giải pháp logistics toàn diện và hiệu quả, góp phần thúc đẩy
               ...
               <MUIGrid container>
                  ...
                  >
                     <ol data-aos="fade-up" data-aos-delay="300" data-aos-duration="2000">
               ...
               <MUIGrid container>
                  ...
                  >
                     <ul data-aos="fade-up" data-aos-delay="300" data-aos-duration="2000">
